---
name: visualize-svg
description: Create and preview animated SVGs, render them to WebM, and attach animation evidence to GitHub pull requests or comments. Use for visual explainers, SMIL or CSS animation, path morphing, motion paths, animated icons and diagrams, or PR-ready animation previews.
---
...
When the user wants a portable video or GitHub review artifact, read
[references/webm-and-github.md](references/webm-and-github.md). WebM export is
optional and has additional dependencies; ordinary SVG preview does not.

## Usage

```bash
# Preview an SVG file
/visualize-svg heartbeat.svg

# Pipe SVG content (preferred for temporary explainers)
cat animation.svg | /visualize-svg
echo '<svg ...>...</svg>' | /visualize-svg
```
